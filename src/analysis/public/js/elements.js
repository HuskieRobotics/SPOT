...
const eventSwitchView = document.getElementById("event-switch-view");
...
const currentEventSwitch = document.getElementById("current-event-switch");
...
const eventMenuContainer = document.getElementById("event-menu");
